...
import TeamSectionReactShowcase from "../components/marketing/TeamSection/TeamSectionReactShowcase.jsx";
...
import FAQSectionReactShowcase from "../components/marketing/FAQSection/FAQSectionReactShowcase.jsx";
...
export default function Showcase() {
  return (
    <main id="layout-page-overlay">
      ...
      <section className="showcase">
        <h2 className="section-title">FAQ Section - Static (HTML+CSS)</h2>
        <FAQSectionHTML />
        <h2 className="section-title">FAQ Section - Interactive (React)</h2>
        <FAQSectionReactShowcase />
        <h2 className="section-title">
          FAQ Section - Interactive (React+Tailwind)
        </h2>
        <FAQSectionTailwind
          faqs={[
            {
