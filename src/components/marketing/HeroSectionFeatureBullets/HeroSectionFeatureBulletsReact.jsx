...
export default function HeroSectionFeatureBulletsReact({ title, bullets, src, alt, width, height }) {
  return (
        ...
        <div className="hero-feature-bullets-content">
          ...
          <div className="hero-feature-bullets-actions">
            <div className="hero-feature-bullets-actions-btn">
              <Link className="hero-feature-bullets-btn btn-secondary" to="#">
                Learn more
              </Link>
            </div>
            <div className="hero-feature-bullets-actions-btn">
              <Link className="hero-feature-bullets-btn btn-primary" to="#">
                See pricing
              </Link>
            </div>
          </div>
